package com.lunatech.imdb.common.log;
...
public class LoggingComponent {
    ...
    @Pointcut("execution(* com.lunatech.imdb.controllers.*.*(..))")
    public void controllersPoint(){}

    @Pointcut("execution(* com.lunatech.imdb.components.*.*.*(..))")
    ...
    public void logBefore(JoinPoint joinPoint) {
        log.info("> {} {}{}", joinPoint.getTarget().getClass(), joinPoint.getSignature().getName(), argumentsToString(joinPoint));
    }
